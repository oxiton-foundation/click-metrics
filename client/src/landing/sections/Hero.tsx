  ...
  return (
    <main className="w-full flex flex-col items-center mt-[10%] sm:mt-0">
      <section className="flex flex-col md:flex-row justify-between w-[95%] items-center mx-auto mt-[5%]">
        <motion.div className="w-full md:w-[45%] flex flex-col items-start md:items-start sm:text-center md:text-left mb-4 md:mb-0" variants={fadeIn(2.2)} initial="hidden" whileInView={"show"} viewport={{once: false, amount: 0.7}}>
        ...
        <motion.div variants={fadeIn4(2.2)} initial="hidden" whileInView={"show"} viewport={{once: false, amount: 0.7}} className="w-full md:w-1/2 flex items-center justify-center">
