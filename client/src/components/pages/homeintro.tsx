  ...
  return (
    <div className="bg-orange-100 m-4 p-4 text-gray-800 py-8 rounded-lg shadow-md">
      ...
      <section className="flex flex-col md:flex-row justify-around mt-8 px-4">
        <div
          className="bg-white p-6 rounded-lg shadow-md w-full md:w-1/4 mt-4 md:mt-0 cursor-pointer"
        ...
        >
          ...
          <p>
            Track detailed analytics for each link, including clicks, referrers,
            and geographic data.
          </p>
        </div>
      </section>
