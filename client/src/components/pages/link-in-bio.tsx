        ...
        <div className="container mx-auto px-4 md:px-0">
          <div className="flex flex-col gap-6 bg-white p-8 md:p-12">
            ...
            <p className="text-gray-600">
              ...
              matter to you. Bitly powers hundreds of thousands of Links-in-bios
              for creators and businesses of all kinds.{" "}
            ...
            <div>
              <div className="gap-3 flex flex-wrap">
                <Label htmlFor="url" className="font-bold text-lg my-4">
                  Claim your URL
                </Label>
              </div>
              <div className="gap-2 flex flex-wrap">
                ...
                {isLoggedIn ? (
                  <Button
                    ...
                    onClick={() => window.alert("Backend not implemented yet")}
                  >
                    Create Page
                  </Button>
                ) : (
              ...
              <div className="w-auto h-auto bg-cyan-100 rounded-lg my-4 flex flex-wrap">
                ...
                <div className="text-cyan-600 text-sm py-4 px-4">
                  Brand your Link-in-bio with a custom domain! You'll even get a
                  complimentary domain when you{" "}
              ...
              <p className="text-black text-sm">
                Your plan includes <b>1</b> more Link-in-bios.{" "}
                <Link to="/help">
                  <QuestionIcon />
                </Link>
              </p>
            ...
            <div className="grid gap-3">
              ...
              <p className="text-gray-600">
                The Bitly Link-in-bio is an easy-to-read, flexible way to
                organize and share your content with the power and reliability
                of Bitly short links. Take a look at these Link-in-bio examples.
              </p>

              <Label className="font-bold text-2xl my-5" htmlFor="url">
                Pick themes
              </Label>
              <Template />
              <Link to="/theme" className="text-blue-700 text-center py-6">
                View more themes
              </Link>
            </div>
          </div>
